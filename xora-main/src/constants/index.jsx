...
export const faq = [
  {
    ...
    answer:
      "Xora is designed to be incredibly easy to setup. Our user-friendly interface and intuitive workflows make it a breeze for anyone to get started.",
  },
  {
    id: "1",
    question: "Can I integrate Xora with other platforms?",
    answer:
      "Absolutely! Xora seamlessly integrates with a wide range of popular platforms, including Zapier, Slack, and Google Drive, allowing you to streamline your workflow and maximize productivity.",
  },
  {
    id: "2",
    question: "How often do you add new content?",
    answer:
      "We are constantly expanding our content library with fresh, innovative templates and tutorials. Our team of experts regularly adds new content to ensure you have access to the latest and greatest resources.",
  },
  {
    id: "3",
    question: "What your refund policy?",
    answer:
      "We offer a 30-day money-back guarantee. If you're not completely satisfied with Xora within the first 30 days, simply contact our support team for a full refund.",
  },
  {
    id: "4",
    question: "Do you have corporate plans?",
    answer:
      "Yes, we offer tailored corporate plans designed to meet the unique needs of businesses of all sizes. Our corporate plans include additional features, dedicated support, and volume discounts.",
  },
  {
    id: "5",
    question: "What happens when I’m out of storage?",
    answer:
      "If you reach your storage limit, you will be unable to upload new files. However, you can easily upgrade your plan to increase your storage capacity and continue using Xora without interruption.",
  },
  {
    id: "6",
    question: "Can I upgrade my plan?",
    answer:
      "Yes, you can upgrade your plan at any time to access additional features and storage capacity. Simply visit the billing page in your account settings to choose the plan that best suits your needs.",
  },
  {
    id: "7",
    question: "How do I invite my team?",
    answer:
      "To invite your team members, simply go to the team management section in your account settings. From there, you can add new users and assign them specific roles and permissions.",
  },
  {
    id: "8",
    question: "Do you offer training for individuals and teams?",
    answer:
      "Yes, we offer both individual and team training sessions to help you get the most out of Xora. Our training sessions are tailored to your specific needs and can be scheduled at your convenience.",
  },
  {
    id: "9",
    question: "I’m locked out of my account what do I do?",
    answer:
      "If you're locked out of your account, simply click on the \"Forgot password\" link on the login page. You will be prompted to enter your email address, and we will send you a link to reset your password.",
  },
];
